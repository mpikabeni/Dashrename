...
def main():
    ...
    async def post_init(app: Application):
        # Application is running/initialized here, so the background task
        # can safely be created without the PTB warning.
        app.create_task(midnight_cleanup_loop(), name="dash-midnight-cleanup")
